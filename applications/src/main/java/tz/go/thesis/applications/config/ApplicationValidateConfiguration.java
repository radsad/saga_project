...
@Configuration
public class ApplicationValidateConfiguration {

	
	@Value("${application.rabbitmq.queue}")
    private String queueName;
	
	@Value("${appfailure.rabbitmq.queue}")
	...
	public static class MyFatalExceptionStrategy extends ConditionalRejectingErrorHandler.DefaultExceptionStrategy {
		...
		private Logger logger = LoggerFactory.getLogger(ApplicationValidateConfiguration .class);
